(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-categories-categories-module~pages-entries-entries-module"],{
...
var BaseResourceFormComponent = /** @class */ (function () {
    function BaseResourceFormComponent(injector, resource, resourceService, jsonDataToResourceFn) {
        ...
        this.formBuilder = this.injector.get(_angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]);
    }
    ...
    BaseResourceFormComponent.prototype.loadResource = function () {
        ...
        if (this.currentAction == "edit") {
            this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(function (params) { return _this.resourceService.getById(+params.get("id")); }))
                .subscribe(function (resource) {
                _this.resource = resource;
                _this.resourceForm.patchValue(resource); // binds loaded resource data to resourceForm
            }, function (error) { return alert('Ocorreu um erro no servidor, tente mais tarde.'); });
        }
    };
...
var BaseResourceListComponent = /** @class */ (function () {
    ...
    BaseResourceListComponent.prototype.deleteResource = function (resource) {
        var _this = this;
        var mustDelete = confirm('Deseja realmente excluir este item?');
        if (mustDelete) {
...
//# sourceMappingURL=default~pages-categories-categories-module~pages-entries-entries-module.js.map